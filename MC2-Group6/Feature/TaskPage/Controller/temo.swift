...
//        super.viewDidLoad()
//        self.TaskTable.sectionHeaderTopPadding = 5
...
//            as! TableViewCell
//        
//        let selectedTask = taskContainer[indexPath.section]
//        
//        let dateFormater = DateFormatter()
//        dateFormater.dateFormat = "d MMM"
//        let taskDate = dateFormater.string(from: selectedTask.dueDate!)
//        
//        cell.TaskName.text = selectedTask.title
//        cell.TaskTag.text = selectedTask.desc
//        cell.TaskDate.text = dateFormater.string(from: selectedTask.dueDate!)
//        cell.delegate = self
//
